...
import AmericanExpressImg from "../../assets/img/svg/americanExpress.svg";
...
const FooteeSection = styled.section`
    background: #f2f2f2;
    padding: 2.5rem;
    display: grid;
    width: 100%;
...
`;
const CompanyExplanation = styled.p`
`;
...
const Footer: React.FC = () => {
    ...
    return (
    <FooteeSection>
        <Company href="https://zero-base.co.kr/">제로베이스</Company>
        <CardList>
            <Card>
                <CardImge src={VisaImg} alt="비자카드" />
            </Card>        
             <Card>
                <CardImge src={MasterImg} alt="마스터카드" />
            </Card>
            <Card>
                <CardImge src={AmericanExpressImg} alt="아메리카카드" />
            </Card>  
            <Card>
                <CardImge src={PaypalImg} alt="페이펠카드" />
            </Card>
            <Card>
                <CardImge src={DinersClubImg} alt="디너클루카드" />
            </Card>
            <Card>
                <CardImge src={DiscoverImg} alt="디스커버리카드" />
            </Card> 
        </CardList>
        <SocialGrid>
            <SocialLinkWrapper>
            ...
            >
                ...
                <path d="m17 2v4h-2c-0.69 0-1 0.81-1 1.5v2.5h3v4h-3v8h-4v-8h-3v-4h3v-4a4 4 0 0 1 4 -4h3z"></path>
                </svg>
            </SocialLink>
        ...
        <CompanyExplanation>Copyright © 2022 Zero Base</CompanyExplanation>
    </FooteeSection>
    )
}
